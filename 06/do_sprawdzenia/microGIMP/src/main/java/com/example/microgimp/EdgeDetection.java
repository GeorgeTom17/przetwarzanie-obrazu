...
public class EdgeDetection {
    ...
    private static float[][] sobelFilteringGetX(float[][] image) {
    ...
    private static float[][] sobelFilteringGetY(float[][] image) {
        int height = image.length;
        int width = image[0].length;
    ...
    private static float[][] reduceMatrix(float[][] image) {
        int height = image.length;
    ...
    private static float[][] expandMatrix(float[][] image) {
        int height = image.length;
        int width = image[0].length * 3;
